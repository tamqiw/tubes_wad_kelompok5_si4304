        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Tambah Fasilitas</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('facility/manage') }}">Fasilitas Ruangan</a></li>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Tambah Fasilitas Ruangan</h4>
                <p class="">Gunakan menu ini untuk menambah daftar/master data dari fasilitas ruangan</p>
            </div>

            <div class="card-body">
                <form action="{{ url('facility/store') }}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="mcontent" id="summernote" rows="10"
                                          placeholder="Keterangan">{{old('mcontent')}}</textarea>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="formFile" class="form-label">Icon Fasilitas</label>
