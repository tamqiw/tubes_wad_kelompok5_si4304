        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Manage Fasilitas</h3>
                    <p class="text-subtitle text-muted">Manage Fasilitas Ruangan</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Fasilitas Ruangan</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Manage Fasilitas Ruangan</h4>
                    </div>
                                ...
                                <div class="dataTable-container">
                                    <table class="table table-striped dataTable-table" id="table_data">
                                        ...
                                        <tr>
                                            ...
                                            <th data-sortable="">Nama Fasilitas</th>
                                        ...
                                        @forelse ($datas as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{url('facility/'.$data->id.'/edit')}}">
...
@push('script')
    ...
    <script type="text/javascript">
        ...
        $('body').on("click", ".btn-delete", function () {
            var id = $(this).attr("id")
            $(".btn-destroy").attr("href", window.location.origin + "/facility/" + id + "/delete")
