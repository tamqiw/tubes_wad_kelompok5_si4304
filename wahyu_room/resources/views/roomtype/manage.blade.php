        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Manage Jenis Ruangan</h3>
                    <p class="text-subtitle text-muted">Manage Jenis Ruangan</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Jenis Ruangan</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Manage Data Jenis Ruangan</h4>
                    </div>
                                    ...
                                    <table class="table table-striped dataTable-table" id="table_data">
                                        ...
                                        @forelse ($datas as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{url('room-type/'.$data->id.'/edit')}}">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Aksi Ini Tidak Dapat Dibatalkan dan akan menghapus seluruh ruangan yang bertipe ini
                </div>
...
@push('script')
    ...
    <script type="text/javascript">
        ...
        $('body').on("click", ".btn-delete", function () {
            var id = $(this).attr("id")
            $(".btn-destroy").attr("href", window.location.origin + "/room-type/" + id + "/delete")
