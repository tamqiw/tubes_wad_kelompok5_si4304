        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Jenis Ruangan</h3>
                    <p class="text-subtitle text-muted">Edit Jenis Ruangan</p>
                </div>
...
@section('page-content')
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action='{{ url("room-type/$data->id/update") }}' enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-12 mb-5">
                            <img src="{{asset($data->photo)}}" style="border-radius: 20px" id="imgPreview"
                                 class="img-fluid" alt="Responsive image">
                            <h5 class="mt-3">Kategori Ruangan : {{$data->name}}</h5>
                        </div>

                        <div class="col-md-6">

                            <div class="form-group">
                                <label for="basicInput">Nama Jenis Ruangan</label>
                                <input type="text" name="name" required class="form-control"
                                       value="{{ old('name',$data->name) }}"
                                       placeholder="Nama Jenis Ruangan">
                            </div>
