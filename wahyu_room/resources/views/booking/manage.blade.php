        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Manage Data Booking</h3>
                    <p class="text-subtitle text-muted">Manage Data Booking User</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Data Booking</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Manage Data Booking</h4>
                    </div>
                                ...
                                <div class="dataTable-container">
                                    <table class="table table-striped dataTable-table" id="table_data">
                                        ...
                                        <tr>
                                            ...
                                            <th data-sortable="">Nomor Booking</th>
                                            <th data-sortable="">Nama Pemesan</th>
                                            <th data-sortable="">Kontak</th>
                                            <th data-sortable="">Tanggal Checkin</th>
                                            <th data-sortable="">Tanggal Checkout</th>
                                            <th data-sortable="">Tanggal Pemesanan</th>
                                            <th data-sortable="">Bukti Bayar</th>
                                        ...
                                        @forelse ($datas as $data)
                                            <tr>
                                                ...
                                                <td>{{ $data->booker_contact }}</td>
                                                <td>{{ $data->checkin }}</td>
                                                <td>{{ $data->checkout }}</td>
                                                <td>{{ $data->created_at }}</td>
                                                <td>
                                                    <a href="{{asset("$data->photo")}}">Lihat Bukti Bayar</a>
                                                </td>
