        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Manage Data Ruangan</p>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Manage Data Ruangan</h4>
                    </div>
                                ...
                                <div class="dataTable-container">
                                    <table class="table table-striped dataTable-table" id="table_data">
                                        ...
                                        <tr>
                                            ...
                                            <th data-sortable="">Nama Ruangan</th>
                                            <th data-sortable="">Tipe</th>
                                            <th data-sortable="">Kapasitas</th>
