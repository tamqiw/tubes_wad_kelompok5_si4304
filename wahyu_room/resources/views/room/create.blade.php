        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Ruangan</h3>
                    <p class="text-subtitle text-muted">Tambah Ruangan Baru</p>
                </div>
...
@section('page-content')
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('room/store') }}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="mcontent" id="summernote" rows="10"
                                          placeholder="Konten Berita">{{old('mcontent')}}</textarea>
                            </div>
                                ...
                                @forelse($facilities as $fats)
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="checkbox" name="facilities[]" id=""
